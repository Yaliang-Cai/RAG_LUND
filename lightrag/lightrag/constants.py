...
DEFAULT_MAX_TOTAL_TOKENS = 45000
DEFAULT_COSINE_THRESHOLD = 0.2
DEFAULT_RELATED_CHUNK_NUMBER = 5
DEFAULT_KG_CHUNK_PICK_METHOD = "VECTOR"
DEFAULT_ENABLE_IMAGE_TOKEN_BUDGET = False
# Query-time synonym-edge filtering default.
# None = auto (PPR modes default False, non-PPR modes default True).
DEFAULT_EXCLUDE_SYNONYM_EDGES = None
DEFAULT_RECOGNITION_TOP_K = 20
DEFAULT_LINKING_TOP_K = 5          # max entity seeds output by recognition memory (HippoRAG2 link_top_k)
