...
async def _merge_nodes_then_upsert(
    ...
    # In disambiguation mode, entity_name may already be the composite graph ID.
    if _disambig and entity_name != canonical_entity_name:
        composite_id = entity_name
    else:
        composite_id = compute_entity_id(canonical_entity_name, entity_type, _disambig)
    node_data = dict(
        entity_id=composite_id,
        entity_type=entity_type,
