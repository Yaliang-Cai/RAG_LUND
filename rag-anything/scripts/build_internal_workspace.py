...
DEFAULT_INTERNAL_MULTIMODAL_ITEM_PARALLELISM = 2
DEFAULT_INTERNAL_EMBEDDING_BATCH_NUM = DEFAULT_EMBEDDING_BATCH_NUM
DEFAULT_INTERNAL_EMBEDDING_FUNC_MAX_ASYNC = DEFAULT_EMBEDDING_FUNC_MAX_ASYNC
DEFAULT_INTERNAL_MULTIMODAL_PROMPT_MAX_INPUT_TOKENS = (
    DEFAULT_MULTIMODAL_PROMPT_MAX_INPUT_TOKENS
)
DEFAULT_INTERNAL_MULTIMODAL_CHUNK_MAX_TOKENS = DEFAULT_MULTIMODAL_CHUNK_MAX_TOKENS
